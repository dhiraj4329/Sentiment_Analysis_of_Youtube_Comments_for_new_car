...
class Prediction:
    ...
    def executeProcessing(self, sentence_list):
        ...
        #print("*" * 50 + " Predicted Output Result" + "*" * 50)
        #print(predictions)
        #predict_dict = {"results" : predictions}
        #print(predict_dict)
        #print("*" * 50 + " Predicted Output Result Ends here" + "*" * 50)
        return predictions
...
#     predictorObj.executeProcessing(sentence_list)